...
class ThreeLayerMLPCurve(nn.Module):
    def __init__(self, fix_points):
        super(ThreeLayerMLPCurve, self).__init__()

        self.dense_1 = curves.Linear(16, 64, fix_points=fix_points)
        self.dense_2 = curves.Linear(64, 32, fix_points=fix_points)
        self.dense_3 = curves.Linear(32, 32, fix_points=fix_points)
        self.dense_4 = curves.Linear(32, 5, fix_points=fix_points)
