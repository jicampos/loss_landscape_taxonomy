...
if __name__ == "__main__":
    ...
    parser.add_argument('--noise-type', type=str, default='gaussian')  # choices=['none', 'bernoulli', 'gaussian', 'uniform', 'positive_uniform'])
    parser.add_argument('--noise', default=False, action='store_true')  # Default: True 
    parser.add_argument('--noise-magnitude', type=float, default=0.1)
