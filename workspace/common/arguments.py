...
def get_parser(code_type='training'):
    ...
    if code_type in ['training', 'CKA', 'hessian', 'curve', 'loss_acc', 'ntk', 'gradient', 'neural_eff']:
        ...
        # parser.add_argument('--noise', action='store_true', default = False, help='training type')
    ...
    if code_type in ['training', 'CKA', 'hessian', 'model_dist', 'curve', 'loss_acc', 'ntk', 'neural_eff']:
    ...
    if code_type in ['CKA', 'hessian', 'model_dist', 'curve', 'loss_acc', 'ntk', 'neural_eff']:
    ...
    if code_type in ['loss_acc', 'neural_eff']:
