...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        train_loss, test_metrics = train(args, model, train_loader, test_loader, optimizer, criterion, epoch)
        
        loss_vals.append(train_loss)
        test_loss_vals.append(test_metrics[0])
        test_acc_vals.append(test_metrics[1])
    ...
    np.save(f'{args.saving_folder}test_loss.npy', np.array(test_loss_vals))
    np.save(f'{args.saving_folder}test_acc.npy', np.array(test_acc_loss))
