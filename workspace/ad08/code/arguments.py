...
def get_parser(code_type='training'):
    ...
    if code_type in ['training', 'CKA', 'hessian', 'curve', 'loss_acc', 'ntk']:
        ...
        parser.add_argument('--weight-precision', type=int, default = 6, help='Weight bitwidth')
        parser.add_argument('--bias-precision', type=int, default = 6, help='Bias bitwidth')
        parser.add_argument('--act-precision', type=int, default = 9, help='Activation bitwidth')
